    ...
    <div className='blackbg'>
      <div className={styles.container}>
        ...
        <div className={styles.textbox}>
          ...
          <p className={styles.text}>
            The Cannabis Potcast is a podcast about the ever-changing landscape
            of Canadian cannabis culture, one toke at a time. It explores
            Canada&apos;s journey thorough the legalization of weed, features
            interviews with field experts and professionals, talks about the
            science and composition of weed and reviews different cultivars.
          </p>
          <p className={styles.text}>
