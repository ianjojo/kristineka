  ...
  return (
    <div className='container'>
      ...
      <div className='textbox'>
        ...
        <p className='text'>
          Created for the CHFA West event, this brochure covers everything from
          how the company got and how it is doing, to the processes of
        ...
        <p className='text'>
          ...
          where you have to slide the sleeve off the tub before you can open the
          tub and dig in.{" "}
        </p>
      </div>
      <div className='wrapper imagewrapper'>
